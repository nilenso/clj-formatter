...
var G__8822 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__8823 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__8822;
lines = G__8823;
continue;
} else {
...
var comma_8829 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_8830 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_8829),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__8825){
...
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_8830,rewrite_clj.node.protocols.coerce(v),comma_8829);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__8831 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__8831) : f.call(null,G__8831));
})(),sq);
});
