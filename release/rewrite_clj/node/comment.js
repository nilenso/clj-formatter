...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k4827,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__4831 = k4827;
var G__4831__$1 = (((G__4831 instanceof cljs.core.Keyword))?G__4831.fqn:null);
switch (G__4831__$1) {
case "prefix":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k4827,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__4832){
var vec__4833 = p__4832;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4833,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4833,(1),null);
...
return cljs.core.pr_sequential_writer(writer__5359__auto__,pr_pair__5361__auto__,"#rewrite-clj.node.comment.CommentNode{",", ","}",opts__5360__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$prefix,self__.prefix],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$s,self__.s],null))], null),self__.__extmap));
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__4826){
var self__ = this;
var G__4826__$1 = this;
return (new cljs.core.RecordIter((0),G__4826__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$prefix,cljs.core.cst$kw$s], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__5154__auto____$1 = (function (){var fexpr__4836 = (function (coll__5340__auto__){
return (495469178 ^ cljs.core.hash_unordered_coll(coll__5340__auto__));
});
return fexpr__4836(this__5339__auto____$1);
})();
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this4828,other4829){
var self__ = this;
var this4828__$1 = this;
return (((!((other4829 == null)))) && ((((this4828__$1.constructor === other4829.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this4828__$1.prefix,other4829.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this4828__$1.s,other4829.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this4828__$1.__extmap,other4829.__extmap)))))))));
}));
...
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$s,null,cljs.core.cst$kw$prefix,null], null), null),k__5354__auto__)){
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k4827){
var self__ = this;
var this__5350__auto____$1 = this;
var G__4837 = k4827;
var G__4837__$1 = (((G__4837 instanceof cljs.core.Keyword))?G__4837.fqn:null);
switch (G__4837__$1) {
case "prefix":
case "s":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k4827);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__4826){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__4838 = cljs.core.keyword_identical_QMARK_;
var expr__4839 = k__5352__auto__;
if(cljs.core.truth_((function (){var G__4841 = cljs.core.cst$kw$prefix;
var G__4842 = expr__4839;
return (pred__4838.cljs$core$IFn$_invoke$arity$2 ? pred__4838.cljs$core$IFn$_invoke$arity$2(G__4841,G__4842) : pred__4838.call(null,G__4841,G__4842));
})())){
return (new rewrite_clj.node.comment.CommentNode(G__4826,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__4843 = cljs.core.cst$kw$s;
var G__4844 = expr__4839;
return (pred__4838.cljs$core$IFn$_invoke$arity$2 ? pred__4838.cljs$core$IFn$_invoke$arity$2(G__4843,G__4844) : pred__4838.call(null,G__4843,G__4844));
})())){
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,G__4826,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__4826),null));
}
}
}));
...
return cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.MapEntry(cljs.core.cst$kw$prefix,self__.prefix,null)),(new cljs.core.MapEntry(cljs.core.cst$kw$s,self__.s,null))], null),self__.__extmap));
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__4826){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,G__4826,self__.__extmap,self__.__hash));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$prefix,cljs.core.cst$sym$s], null);
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__4830){
var extmap__5385__auto__ = (function (){var G__4845 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__4830,cljs.core.cst$kw$prefix,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$s], 0));
if(cljs.core.record_QMARK_(G__4830)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__4845);
} else {
return G__4845;
}
})();
return (new rewrite_clj.node.comment.CommentNode(cljs.core.cst$kw$prefix.cljs$core$IFn$_invoke$arity$1(G__4830),cljs.core.cst$kw$s.cljs$core$IFn$_invoke$arity$1(G__4830),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
