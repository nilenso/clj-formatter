...
return (new cljs.core.List(null,cljs.core.cst$sym$fn_STAR_,(new cljs.core.List(null,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fixed_arg_syms,(cljs.core.truth_(vararg_sym)?(new cljs.core.List(null,cljs.core.cst$sym$_AMPERSAND_,(new cljs.core.List(null,vararg_sym,null,(1),null)),(2),null)):null))),(new cljs.core.List(null,body,null,(1),null)),(2),null)),(3),null));
});
/**
...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__7036(s__7037){
return (new cljs.core.LazySeq(null,(function (){
var s__7037__$1 = s__7037;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__7037__$1);
if(temp__5804__auto__){
var s__7037__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__7037__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__7037__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__7039 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__7038 = (0);
while(true){
if((i__7038 < size__5522__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5521__auto__,i__7038);
...
cljs.core.chunk_append(b__7039,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__7039),rewrite_clj$node$fn$fn_walk_$_iter__7036(cljs.core.chunk_rest(s__7037__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__7039),null);
}
} else {
var i = cljs.core.first(s__7037__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__7036(cljs.core.rest(s__7037__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__7035_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__7035_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k7042,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k7042,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__7047){
var vec__7048 = p__7047;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7048,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7048,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__7041){
var self__ = this;
var G__7041__$1 = this;
return (new cljs.core.RecordIter((0),G__7041__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$children], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__5154__auto____$1 = (function (){var fexpr__7051 = (function (coll__5340__auto__){
return (-1740346885 ^ cljs.core.hash_unordered_coll(coll__5340__auto__));
});
return fexpr__7051(this__5339__auto____$1);
})();
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this7043,other7044){
var self__ = this;
var this7043__$1 = this;
return (((!((other7044 == null)))) && ((((this7043__$1.constructor === other7044.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this7043__$1.children,other7044.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this7043__$1.__extmap,other7044.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k7042){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k7042);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__7041){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__7053 = cljs.core.keyword_identical_QMARK_;
var expr__7054 = k__5352__auto__;
if(cljs.core.truth_((function (){var G__7056 = cljs.core.cst$kw$children;
var G__7057 = expr__7054;
return (pred__7053.cljs$core$IFn$_invoke$arity$2 ? pred__7053.cljs$core$IFn$_invoke$arity$2(G__7056,G__7057) : pred__7053.call(null,G__7056,G__7057));
})())){
return (new rewrite_clj.node.fn.FnNode(G__7041,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__7041),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__7041){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__7041,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__7045){
var extmap__5385__auto__ = (function (){var G__7058 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__7045,cljs.core.cst$kw$children);
if(cljs.core.record_QMARK_(G__7045)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__7058);
} else {
return G__7058;
}
})();
return (new rewrite_clj.node.fn.FnNode(cljs.core.cst$kw$children.cljs$core$IFn$_invoke$arity$1(G__7045),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
