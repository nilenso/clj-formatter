...
var rewrite_clj$node$protocols$Node$tag$dyn_4662 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_4662(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_4663 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_4663(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_4664 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_4664(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_4665 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_4665(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_4666 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_4666(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_4667 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_4667(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__4671_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__4671_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_4675 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_4675(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_4676 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_4676(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_4677 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_4677(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_4678 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_4678(node);
}
});
...
return (((!((x == null)))) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$unknown,rewrite_clj.node.protocols.tag(x))));
});
rewrite_clj.node.protocols.default_auto_resolve = (function rewrite_clj$node$protocols$default_auto_resolve(alias){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$current,alias)){
return cljs.core.cst$sym$_QMARK__current_DASH_ns__QMARK_;
} else {
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_4682 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_4682(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_4683 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_4683(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_4684 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_4684(node);
}
});
...
var map__4687 = cljs.core.meta(node);
var map__4687__$1 = cljs.core.__destructure_map(map__4687);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4687__$1,cljs.core.cst$kw$row);
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4687__$1,cljs.core.cst$kw$col);
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4687__$1,cljs.core.cst$kw$next_DASH_row);
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4687__$1,cljs.core.cst$kw$next_DASH_col);
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__4688,p__4689){
var vec__4690 = p__4688;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4690,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4690,(1),null);
var vec__4693 = p__4689;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4693,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4693,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__4696 = col_extent;
if((row_extent === (0))){
return (G__4696 + col);
} else {
return G__4696;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,cljs.core.meta(form),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.cst$kw$column,cljs.core.cst$kw$end_DASH_line,cljs.core.cst$kw$end_DASH_column], null));
});
/**
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__4697 = rewrite_clj.node.protocols.children(node);
var G__4697__$1 = (((G__4697 == null))?null:cljs.core.first(G__4697));
if((G__4697__$1 == null)){
return null;
} else {
var fexpr__4698 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr);
return (fexpr__4698.cljs$core$IFn$_invoke$arity$1 ? fexpr__4698.cljs$core$IFn$_invoke$arity$1(G__4697__$1) : fexpr__4698.call(null,G__4697__$1));
}
} else {
