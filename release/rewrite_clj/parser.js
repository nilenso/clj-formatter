...
var position_meta = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.meta(cljs.core.first(nodes)),cljs.core.select_keys(cljs.core.meta(cljs.core.last(nodes)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$end_DASH_row,cljs.core.cst$kw$end_DASH_col], null))], 0));
