...
var G__8762 = rewrite_clj.zip.move.next(rewrite_clj.zip.walk.process_loc(loc,p_QMARK_,f));
loc = G__8762;
continue;
}
break;
...
var G__8766 = rewrite_clj.zip.walk.downmost(rewrite_clj.zip.move.right(loc__$1));
loc = G__8766;
continue;
} else {
if(cljs.core.truth_(rewrite_clj.zip.move.up(loc__$1))){
var G__8767 = rewrite_clj.zip.move.up(loc__$1);
loc = G__8767;
continue;
} else {
return loc__$1;
...
return rewrite_clj.zip.subedit.subedit_node(zloc,(function (p1__8768_SHARP_){
return rewrite_clj.zip.walk.postwalk_subtree(p_QMARK_,f,p1__8768_SHARP_);
}));
}));
