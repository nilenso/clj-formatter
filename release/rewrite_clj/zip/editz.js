...
return rewrite_clj.node.protocols.coerce((function (){var G__8743 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__8743) : f.call(null,G__8743));
})());
});
});
/**
...
var len__5769__auto___8748 = arguments.length;
var i__5770__auto___8749 = (0);
while(true){
if((i__5770__auto___8749 < len__5769__auto___8748)){
args__5775__auto__.push((arguments[i__5770__auto___8749]));

var G__8750 = (i__5770__auto___8749 + (1));
i__5770__auto___8749 = G__8750;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__8744_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__8744_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq8745){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8746,G__8747,seq8745__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__8751 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__8751) : str_fn.call(null,G__8751));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__8752 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__8752) : str_fn.call(null,G__8752));
})()):null)));
...
var n = cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(rewrite_clj.custom_zipper.core.node(zloc),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$lines], null),cljs.core.comp.cljs$core$IFn$_invoke$arity$2(line_fn,cljs.core.vec));
...
var G__8755 = rewrite_clj.zip.base.tag(zloc);
var G__8755__$1 = (((G__8755 instanceof cljs.core.Keyword))?G__8755.fqn:null);
switch (G__8755__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__8753_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__8753_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__8754_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__8754_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8755__$1)].join('')));
...
var G__8758 = rewrite_clj.zip.base.tag(zloc);
var G__8758__$1 = (((G__8758 instanceof cljs.core.Keyword))?G__8758.fqn:null);
switch (G__8758__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__8757_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__8757_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8758__$1)].join('')));
