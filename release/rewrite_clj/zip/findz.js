...
var len__5769__auto___8690 = arguments.length;
var i__5770__auto___8691 = (0);
while(true){
if((i__5770__auto___8691 < len__5769__auto___8690)){
args__5775__auto__.push((arguments[i__5770__auto___8691]));

var G__8692 = (i__5770__auto___8691 + (1));
i__5770__auto___8691 = G__8692;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__8686){
var vec__8687 = p__8686;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8687,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__8683_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq8684){
var G__8685 = cljs.core.first(seq8684);
var seq8684__$1 = cljs.core.next(seq8684);
...
var vec__8693 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$row.cljs$core$IFn$_invoke$arity$1(pos),cljs.core.cst$kw$col.cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8693,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8693,(1),null);
if((((r <= (0))) || ((c <= (0))))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("zipper row and col positions are ones-based",new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$pos,pos], null));
} else {
}

var vec__8696 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__8699 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8696,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8699,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8699,(1),null);
var vec__8702 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8696,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8702,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8702,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__8708_SHARP_){
var and__5043__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__8708_SHARP_) : p_QMARK_.call(null,p1__8708_SHARP_));
if(cljs.core.truth_(and__5043__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__8708_SHARP_,pos);
} else {
return and__5043__auto__;
}
...
var G__8714 = zloc;
var G__8714__$1 = (((G__8714 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__8714) : f.call(null,G__8714)));
if((G__8714__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__8714__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__8716_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__8716_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__8723_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__8723_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__8730_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__8730_SHARP_),v);
}));
