...
var G__7261 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,n);
nodes = G__7261;
continue;
} else {
...
var vec__7262 = rewrite_clj.parser.namespaced_map.parse_to_next_elem(reader,read_next);
var whitespace_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7262,(0),null);
var map_node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7262,(1),null);
if(((cljs.core.not(map_node)) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$map,rewrite_clj.node.protocols.tag(map_node))))){
