...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(node,cljs.core.cst$kw$content,(function (){var and__5043__auto__ = children;
...
var G__4549 = clojure.zip.node(loc);
var fexpr__4548 = cljs.core.cst$kw$zip_SLASH_branch_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__4548.cljs$core$IFn$_invoke$arity$1 ? fexpr__4548.cljs$core$IFn$_invoke$arity$1(G__4549) : fexpr__4548.call(null,G__4549));
});
/**
...
var G__4551 = clojure.zip.node(loc);
var fexpr__4550 = cljs.core.cst$kw$zip_SLASH_children.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__4550.cljs$core$IFn$_invoke$arity$1 ? fexpr__4550.cljs$core$IFn$_invoke$arity$1(G__4551) : fexpr__4550.call(null,G__4551));
} else {
...
var fexpr__4552 = cljs.core.cst$kw$zip_SLASH_make_DASH_node.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__4552.cljs$core$IFn$_invoke$arity$2 ? fexpr__4552.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__4552.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__4553 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4553,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4553,(1),null);
var vec__4556 = clojure.zip.children(loc);
var seq__4557 = cljs.core.seq(vec__4556);
var first__4558 = cljs.core.first(seq__4557);
var seq__4557__$1 = cljs.core.next(seq__4557);
var c = first__4558;
var cnext = seq__4557__$1;
var cs = vec__4556;
...
var vec__4559 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4559,(0),null);
var map__4562 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4559,(1),null);
var map__4562__$1 = cljs.core.__destructure_map(map__4562);
var path = map__4562__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4562__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4562__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4562__$1,cljs.core.cst$kw$pnodes);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4562__$1,cljs.core.cst$kw$r);
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4562__$1,cljs.core.cst$kw$changed_QMARK_);
...
var vec__4564 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4564,(0),null);
var map__4567 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4564,(1),null);
var map__4567__$1 = cljs.core.__destructure_map(map__4567);
var path = map__4567__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4567__$1,cljs.core.cst$kw$l);
var vec__4568 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4567__$1,cljs.core.cst$kw$r);
var seq__4569 = cljs.core.seq(vec__4568);
var first__4570 = cljs.core.first(seq__4569);
var seq__4569__$1 = cljs.core.next(seq__4569);
var r = first__4570;
var rnext = seq__4569__$1;
var rs = vec__4568;
...
var vec__4571 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4571,(0),null);
var map__4574 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4571,(1),null);
var map__4574__$1 = cljs.core.__destructure_map(map__4574);
var path = map__4574__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4574__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4574__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__4575 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4575,(0),null);
var map__4578 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4575,(1),null);
var map__4578__$1 = cljs.core.__destructure_map(map__4578);
var path = map__4578__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4578__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4578__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__4579 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4579,(0),null);
var map__4582 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4579,(1),null);
var map__4582__$1 = cljs.core.__destructure_map(map__4582);
var path = map__4582__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4582__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4582__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__4583 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4583,(0),null);
var map__4586 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4583,(1),null);
var map__4586__$1 = cljs.core.__destructure_map(map__4586);
var path = map__4586__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4586__$1,cljs.core.cst$kw$l);
if((path == null)){
throw "Insert at top";
} else {
...
var vec__4587 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4587,(0),null);
var map__4590 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4587,(1),null);
var map__4590__$1 = cljs.core.__destructure_map(map__4590);
var path = map__4590__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4590__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Insert at top";
} else {
...
var vec__4591 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4591,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4591,(1),null);
...
var len__5769__auto___4597 = arguments.length;
var i__5770__auto___4598 = (0);
while(true){
if((i__5770__auto___4598 < len__5769__auto___4597)){
args__5775__auto__.push((arguments[i__5770__auto___4598]));

var G__4599 = (i__5770__auto___4598 + (1));
i__5770__auto___4598 = G__4599;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq4594){
var G__4595 = cljs.core.first(seq4594);
var seq4594__$1 = cljs.core.next(seq4594);
var G__4596 = cljs.core.first(seq4594__$1);
var seq4594__$2 = cljs.core.next(seq4594__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4595,G__4596,seq4594__$2);
}));
...
var G__4601 = clojure.zip.rightmost(child);
loc__$1 = G__4601;
continue;
} else {
return loc__$1;
...
var vec__4602 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4602,(0),null);
var map__4605 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4602,(1),null);
var map__4605__$1 = cljs.core.__destructure_map(map__4605);
var path = map__4605__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4605__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4605__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4605__$1,cljs.core.cst$kw$pnodes);
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4605__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Remove at top";
} else {
...
var G__4606 = clojure.zip.rightmost(child);
loc__$1 = G__4606;
continue;
} else {
return loc__$1;
