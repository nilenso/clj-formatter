...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_4894 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_4894(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_4895 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_4895(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_4896 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_4896(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_4897 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_4897(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_4898 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_4898(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_4899 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_4899(reader);
}
});
...
var G__4910 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__4911 = s.append(c);
c = G__4910;
s = G__4911;
continue;
}
