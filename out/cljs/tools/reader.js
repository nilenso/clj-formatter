...
var G__876 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__876;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__877 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__877,ch);
...
if(("\\" === ch__$1)){
var ch_878__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_878__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_878__$2);
} else {
}

var G__879 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__879;
continue;
}
}
...
var vec__887 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__887,(0),null);
var start_column = cljs.core.nth.call(null,vec__887,(1),null);
...
var G__890 = cljs.core.conj_BANG_.call(null,a,form);
a = G__890;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__891 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__892 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__892);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__891);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__893 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__893,(0),null);
var start_column = cljs.core.nth.call(null,vec__893,(1),null);
...
var vec__896 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__896,(0),null);
var end_column = cljs.core.nth.call(null,vec__896,(1),null);
...
var vec__905 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__905,(0),null);
var start_column = cljs.core.nth.call(null,vec__905,(1),null);
...
var vec__908 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__908,(0),null);
var end_column = cljs.core.nth.call(null,vec__908,(1),null);
...
var sb = (function (){var G__911 = (new goog.string.StringBuffer());
G__911.append(initch);
...
var G__913 = (function (){var G__912 = sb;
G__912.append(ch);

return G__912;
})();
var G__914 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__913;
ch = G__914;
continue;
}
...
switch (G__917) {
case "\\":
var G__921 = (function (){var G__918 = sb;
G__918.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__918;
})();
var G__922 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__921;
ch = G__922;
continue;
...
break;
default:
var G__923 = (function (){var G__919 = sb;
G__919.append(ch);

return G__919;
})();
var G__924 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__923;
ch = G__924;
continue;
...
var vec__925 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__925,(0),null);
var end_column = cljs.core.nth.call(null,vec__925,(1),null);
...
var vec__928 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__928,(0),null);
var column = cljs.core.nth.call(null,vec__928,(1),null);
...
var line = cljs.core.nth.call(null,vec__933,(0),null);
var column = cljs.core.nth.call(null,vec__933,(1),null);
...
var vec__938 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__938,(0),null);
var column = cljs.core.nth.call(null,vec__938,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__943 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__943,(0),null);
var start_column = cljs.core.nth.call(null,vec__943,(1),null);
...
var vec__946 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__946,(0),null);
var end_column = cljs.core.nth.call(null,vec__946,(1),null);
...
var G__949 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__949,true,null,opts,pending_forms);
...
var G__950 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__950)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__950)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__950)){
...
var _STAR_suppress_read_STAR__orig_val__951 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__952 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__952);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__951);
}});
...
var G__953 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__953,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__953,rdr,first_line);
...
var G__957 = matched;
var G__958 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__957;
finished = G__958;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__959 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__960 = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__960);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__959);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__961 = cljs.tools.reader.arg_env;
var arg_env_temp_val__962 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__962);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__963 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__963,"(");
...
var G__964 = (i + (1));
var G__965 = cljs.core.conj_BANG_.call(null,args,(function (){var or__5045__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__961);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__966 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__966);
...
var G__967 = cljs.core.next.call(null,s__$1);
var G__968 = ret;
s__$1 = G__967;
r = G__968;
continue;
...
var G__969 = cljs.core.next.call(null,s);
var G__970 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__969;
key_vals = G__970;
continue;
} else {
...
var gensym_env_orig_val__973 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__974 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__974);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__973);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__975 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__975,(0),null);
var start_column = cljs.core.nth.call(null,vec__975,(1),null);
...
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__978 = token;
var G__978__$1 = (((G__978 == null))?null:cljs.core.subs.call(null,G__978,(1)));
var G__978__$2 = (((G__978__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__978__$1));
var G__978__$3 = (((G__978__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__978__$2));
var G__978__$4 = (((G__978__$3 == null))?null:cljs.core.symbol.call(null,G__978__$3));
if((G__978__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__978__$4);
}
})():(function (){var G__979 = token;
var G__979__$1 = (((G__979 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__979));
if((G__979__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__979__$1);
}
})()
));
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__980 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__980,(0),null);
var end_column = cljs.core.nth.call(null,vec__980,(1),null);
...
}catch (e989){if((e989 instanceof Error)){
var e = e989;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__993,reader){
var map__994 = p__993;
var map__994__$1 = cljs.core.__destructure_map.call(null,map__994);
var opts = map__994__$1;
var eof = cljs.core.get.call(null,map__994__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
