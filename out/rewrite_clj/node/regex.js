...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k2968,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k2968,else__5346__auto__);
...
return cljs.core.reduce.call(null,(function (ret__5366__auto__,p__2973){
var vec__2974 = p__2973;
var k__5367__auto__ = cljs.core.nth.call(null,vec__2974,(0),null);
var v__5368__auto__ = cljs.core.nth.call(null,vec__2974,(1),null);
...
return cljs.core.pr_sequential_writer.call(null,writer__5359__auto__,pr_pair__5361__auto__,"#rewrite-clj.node.regex.RegexNode{",", ","}",opts__5360__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"pattern","pattern",242135423),self__.pattern],null))], null),self__.__extmap));
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__2967){
var self__ = this;
var G__2967__$1 = this;
return (new cljs.core.RecordIter((0),G__2967__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
return (705094795 ^ cljs.core.hash_unordered_coll.call(null,coll__5340__auto__));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this2969,other2970){
var self__ = this;
var this2969__$1 = this;
return (((!((other2970 == null)))) && ((((this2969__$1.constructor === other2970.constructor)) && (((cljs.core._EQ_.call(null,this2969__$1.pattern,other2970.pattern)) && (cljs.core._EQ_.call(null,this2969__$1.__extmap,other2970.__extmap)))))));
}));
...
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pattern","pattern",242135423),null], null), null),k__5354__auto__)){
...
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__5354__auto__)),null));
}
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k2968){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k2968);

}
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__2967){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__2978 = cljs.core.keyword_identical_QMARK_;
var expr__2979 = k__5352__auto__;
if(cljs.core.truth_(pred__2978.call(null,new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__2979))){
return (new rewrite_clj.node.regex.RegexNode(G__2967,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5352__auto__,G__2967),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__2967){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__2967,self__.__extmap,self__.__hash));
}));
...
return cljs.core._write.call(null,writer__5390__auto__,"rewrite-clj.node.regex/RegexNode");
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__2971){
var extmap__5385__auto__ = (function (){var G__2981 = cljs.core.dissoc.call(null,G__2971,new cljs.core.Keyword(null,"pattern","pattern",242135423));
if(cljs.core.record_QMARK_.call(null,G__2971)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__2981);
} else {
return G__2981;
}
})();
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__2971),null,cljs.core.not_empty.call(null,extmap__5385__auto__),null));
});
