...
var rewrite_clj$node$protocols$Node$tag$dyn_577 = (function (node){
...
return m__5394__auto__.call(null,node);
} else {
var m__5392__auto__ = (rewrite_clj.node.protocols.tag["_"]);
if((!((m__5392__auto__ == null)))){
return m__5392__auto__.call(null,node);
} else {
...
return rewrite_clj$node$protocols$Node$tag$dyn_577.call(null,node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_578 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_578.call(null,node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_579 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_579.call(null,node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_580 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
var m__5394__auto__ = (rewrite_clj.node.protocols.sexpr_STAR_[goog.typeOf(x__5393__auto__)]);
if((!((m__5394__auto__ == null)))){
return m__5394__auto__.call(null,node,opts);
} else {
var m__5392__auto__ = (rewrite_clj.node.protocols.sexpr_STAR_["_"]);
if((!((m__5392__auto__ == null)))){
return m__5392__auto__.call(null,node,opts);
} else {
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_580.call(null,node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_581 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_581.call(null,node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_582 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_582.call(null,node);
}
});
...
return cljs.core.map.call(null,(function (p1__586_SHARP_){
return rewrite_clj.node.protocols.sexpr.call(null,p1__586_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_590 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_590.call(null,node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_591 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_591.call(null,node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_592 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
var m__5394__auto__ = (rewrite_clj.node.protocols.replace_children[goog.typeOf(x__5393__auto__)]);
if((!((m__5394__auto__ == null)))){
return m__5394__auto__.call(null,node,children);
} else {
var m__5392__auto__ = (rewrite_clj.node.protocols.replace_children["_"]);
if((!((m__5392__auto__ == null)))){
return m__5392__auto__.call(null,node,children);
} else {
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_592.call(null,node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_593 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_593.call(null,node);
}
});
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_597.call(null,form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_598 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
var m__5394__auto__ = (rewrite_clj.node.protocols.map_context_apply[goog.typeOf(x__5393__auto__)]);
if((!((m__5394__auto__ == null)))){
return m__5394__auto__.call(null,node,map_qualifier);
} else {
var m__5392__auto__ = (rewrite_clj.node.protocols.map_context_apply["_"]);
if((!((m__5392__auto__ == null)))){
return m__5392__auto__.call(null,node,map_qualifier);
} else {
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_598.call(null,node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_599 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_599.call(null,node);
}
});
...
var map__602 = cljs.core.meta.call(null,node);
var map__602__$1 = cljs.core.__destructure_map.call(null,map__602);
var row = cljs.core.get.call(null,map__602__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.call(null,map__602__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.call(null,map__602__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.call(null,map__602__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__603,p__604){
var vec__605 = p__603;
var row = cljs.core.nth.call(null,vec__605,(0),null);
var col = cljs.core.nth.call(null,vec__605,(1),null);
var vec__608 = p__604;
var row_extent = cljs.core.nth.call(null,vec__608,(0),null);
var col_extent = cljs.core.nth.call(null,vec__608,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__611 = col_extent;
if((row_extent === (0))){
return (G__611 + col);
} else {
return G__611;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_.call(null,node))){
var G__612 = rewrite_clj.node.protocols.children.call(null,node);
var G__612__$1 = (((G__612 == null))?null:cljs.core.first.call(null,G__612));
if((G__612__$1 == null)){
return null;
} else {
return cljs.core.juxt.call(null,rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr).call(null,G__612__$1);
}
} else {
