...
var len__5769__auto___4474 = arguments.length;
var i__5770__auto___4475 = (0);
while(true){
if((i__5770__auto___4475 < len__5769__auto___4474)){
args__5775__auto__.push((arguments[i__5770__auto___4475]));

var G__4476 = (i__5770__auto___4475 + (1));
i__5770__auto___4475 = G__4476;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__4470){
var vec__4471 = p__4470;
var additional = cljs.core.nth.call(null,vec__4471,(0),null);
if(cljs.core.truth_(additional)){
return (function (node){
var and__5043__auto__ = cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,node),t);
...
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__4467_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq4468){
var G__4469 = cljs.core.first.call(null,seq4468);
var seq4468__$1 = cljs.core.next.call(null,seq4468);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4469,seq4468__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__4477 = ((cljs.core.map_QMARK_.call(null,pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.call(null,vec__4477,(0),null);
var c = cljs.core.nth.call(null,vec__4477,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__4480 = rewrite_clj.custom_zipper.core.position_span.call(null,zloc);
var vec__4483 = cljs.core.nth.call(null,vec__4480,(0),null);
var zstart_row = cljs.core.nth.call(null,vec__4483,(0),null);
var zstart_col = cljs.core.nth.call(null,vec__4483,(1),null);
var vec__4486 = cljs.core.nth.call(null,vec__4480,(1),null);
var zend_row = cljs.core.nth.call(null,vec__4486,(0),null);
var zend_col = cljs.core.nth.call(null,vec__4486,(1),null);
var and__5043__auto__ = (r >= zstart_row);
if(and__5043__auto__){
var and__5043__auto____$1 = (r <= zend_row);
if(and__5043__auto____$1){
var and__5043__auto____$2 = ((cljs.core._EQ_.call(null,r,zstart_row))?(c >= zstart_col):true);
...
return cljs.core.last.call(null,cljs.core.filter.call(null,(function (p1__4492_SHARP_){
var and__5043__auto__ = p_QMARK_.call(null,p1__4492_SHARP_);
if(cljs.core.truth_(and__5043__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_.call(null,p1__4492_SHARP_,pos);
} else {
return and__5043__auto__;
}
...
var G__4498 = zloc;
var G__4498__$1 = (((G__4498 == null))?null:f.call(null,G__4498));
if((G__4498__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.call(null,G__4498__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.call(null,zloc,f,(function (p1__4500_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__4500_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.call(null,zloc,pos,(function (p1__4507_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__4507_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_.call(null,v))?cljs.core.comp.call(null,v,rewrite_clj.zip.base.sexpr):(function (p1__4514_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.sexpr.call(null,p1__4514_SHARP_),v);
}));
