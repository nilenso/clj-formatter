...
var or__5045__auto__ = f.call(null,zloc);
...
var G__4543 = rewrite_clj.zip.move.next.call(null,rewrite_clj.zip.walk.process_loc.call(null,loc,p_QMARK_,f));
loc = G__4543;
continue;
}
break;
...
var G__4547 = rewrite_clj.zip.walk.downmost.call(null,rewrite_clj.zip.move.right.call(null,loc__$1));
loc = G__4547;
continue;
} else {
if(cljs.core.truth_(rewrite_clj.zip.move.up.call(null,loc__$1))){
var G__4548 = rewrite_clj.zip.move.up.call(null,loc__$1);
loc = G__4548;
continue;
} else {
return loc__$1;
...
return rewrite_clj.zip.subedit.subedit_node.call(null,zloc,(function (p1__4549_SHARP_){
return rewrite_clj.zip.walk.postwalk_subtree.call(null,p_QMARK_,f,p1__4549_SHARP_);
}));
}));
