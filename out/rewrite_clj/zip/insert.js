...
return cljs.core.reduce.call(null,insert_fn,zloc,cljs.core.concat.call(null,(cljs.core.truth_((function (){var and__5043__auto__ = next_node;
...
return rewrite_clj.zip.insert.insert.call(null,(function (p1__4523_SHARP_){
var G__4524 = p1__4523_SHARP_;
var G__4524__$1 = (((G__4524 == null))?null:rewrite_clj.custom_zipper.core.down.call(null,G__4524));
if((G__4524__$1 == null)){
return null;
} else {
return rewrite_clj.custom_zipper.core.rightmost.call(null,G__4524__$1);
}
