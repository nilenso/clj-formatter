...
return rewrite_clj.zip.walk.postwalk.call(null,zloc,(function (p1__4569_SHARP_){
var G__4570 = rewrite_clj.custom_zipper.core.node.call(null,p1__4569_SHARP_);
if((!((G__4570 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__4570.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__4570.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,rewrite_clj.node.protocols.MapQualifiable,G__4570);
} else {
return false;
}
}
