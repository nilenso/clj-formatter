...
var and__5043__auto__ = cljs.core._EQ_.call(null,(1),rewrite_clj.zip.removez.node_depth.call(null,zloc));
if(and__5043__auto__){
var and__5043__auto____$1 = cljs.core.not.call(null,rewrite_clj.zip.move.right.call(null,zloc));
...
var _PERCENT_ = (function (){var ws_pred_fn = (function (p1__3066_SHARP_){
var and__5043__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_.call(null,p1__3066_SHARP_);
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.not.call(null,rewrite_clj.zip.whitespace.linebreak_QMARK_.call(null,p1__3066_SHARP_));
} else {
return and__5043__auto__;
}
});
return rewrite_clj.zip.removez.remove_with_trim.call(null,zloc,(function (p1__3067_SHARP_){
return rewrite_clj.zip.removez.left_ws_trim.call(null,p1__3067_SHARP_,ws_pred_fn);
}),(function (p1__3068_SHARP_){
return rewrite_clj.zip.removez.right_ws_trim.call(null,p1__3068_SHARP_,ws_pred_fn);
}));
})();
if(cljs.core.truth_(_PERCENT_)){
} else {
