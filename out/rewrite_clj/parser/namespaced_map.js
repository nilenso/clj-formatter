...
var or__5045__auto__ = rewrite_clj.reader.boundary_QMARK_.call(null,c);
if(or__5045__auto__){
...
var G__2941 = cljs.core.conj.call(null,nodes,n);
nodes = G__2941;
continue;
} else {
...
var vec__2942 = rewrite_clj.parser.namespaced_map.parse_to_next_elem.call(null,reader,read_next);
var whitespace_nodes = cljs.core.nth.call(null,vec__2942,(0),null);
var map_node = cljs.core.nth.call(null,vec__2942,(1),null);
